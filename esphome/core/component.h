...
// Helpers generated by esphome's codegen when safe_mode is enabled; see
// EsphomeCore.finalize_setup_split. setup() only calls these two plus the
// safe_mode check, so the helpers need the same protected-member access
// the monolithic setup() has today.
void setup_core();
void setup_user();
...
#pragma GCC diagnostic pop
 ...
 protected:
  ...
  friend void ::setup_core();
  friend void ::setup_user();
