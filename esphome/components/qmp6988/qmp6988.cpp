...
int32_t QMP6988Component::get_compensated_pressure_(qmp6988_ik_data_t *ik, int32_t dp, int16_t tx) {
  ...
  // wk1 = 48Q16 // bit size
  wk1 = (ik->bt1 * (int64_t) tx);        // 28Q15+16-1=43 (43Q15)
  wk2 = (ik->bp1 * (int64_t) dp) >> 5;   // 31Q20+24-1=54 (49Q15)
  wk1 += wk2;                            // 43,49->50Q15
  wk2 = (ik->bt2 * (int64_t) tx) >> 1;   // 34Q38+16-1=49 (48Q37)
  wk2 = (wk2 * (int64_t) tx) >> 8;       // 48Q37+16-1=63 (55Q29)
  wk3 = wk2;                             // 55Q29
  wk2 = (ik->b11 * (int64_t) tx) >> 4;   // 28Q34+16-1=43 (39Q30)
  wk2 = (wk2 * (int64_t) dp) >> 1;       // 39Q30+24-1=62 (61Q29)
  wk3 += wk2;                            // 55,61->62Q29
  wk2 = (ik->bp2 * (int64_t) dp) >> 13;  // 29Q43+24-1=52 (39Q30)
  wk2 = (wk2 * (int64_t) dp) >> 1;       // 39Q30+24-1=62 (61Q29)
  wk3 += wk2;                            // 62,61->63Q29
  wk1 += wk3 >> 14;                      // Q29 >> 14 -> Q15
  wk2 = (ik->b12 * (int64_t) tx);        // 29Q53+16-1=45 (45Q53)
  wk2 = (wk2 * (int64_t) tx) >> 22;      // 45Q53+16-1=61 (39Q31)
  wk2 = (wk2 * (int64_t) dp) >> 1;       // 39Q31+24-1=62 (61Q30)
  wk3 = wk2;                             // 61Q30
  wk2 = (ik->b21 * (int64_t) tx) >> 6;   // 29Q60+16-1=45 (39Q54)
  wk2 = (wk2 * (int64_t) dp) >> 23;      // 39Q54+24-1=62 (39Q31)
  wk2 = (wk2 * (int64_t) dp) >> 1;       // 39Q31+24-1=62 (61Q20)
  wk3 += wk2;                            // 61,61->62Q30
  wk2 = (ik->bp3 * (int64_t) dp) >> 12;  // 28Q65+24-1=51 (39Q53)
