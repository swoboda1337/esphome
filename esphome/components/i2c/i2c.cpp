...
ErrorCode I2CDevice::read_register(uint8_t a_register, uint8_t *data, size_t len) {
  return bus_->write_readv(this->address_, &a_register, 1, data, len, this);
}

ErrorCode I2CDevice::read_register16(uint16_t a_register, uint8_t *data, size_t len) {
  a_register = convert_big_endian(a_register);
  return bus_->write_readv(this->address_, reinterpret_cast<const uint8_t *>(&a_register), 2, data, len, this);
}
...
ErrorCode I2CDevice::write_register(uint8_t a_register, const uint8_t *data, size_t len) const {
  ...
  return this->bus_->write_readv(this->address_, buffer, len + 1, nullptr, 0, this);
}
...
ErrorCode I2CDevice::write_register16(uint16_t a_register, const uint8_t *data, size_t len) const {
  ...
  return this->bus_->write_readv(this->address_, buffer, len + 2, nullptr, 0, this);
}
